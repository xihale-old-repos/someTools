    var canvas = document.createElement("canvas"),body = document.createElement("style");  //创建动画元素
    document.body.appendChild(canvas);document.body.appendChild(body);  //增加段落元素到body元素下
    body.innerHTML="\
    html, body {\
  overflow: hidden;\
  background: #000;\
